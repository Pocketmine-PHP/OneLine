...
class OneLine extends PluginBase implements Listener{
    ...
    public function onEnable() {
        ...
        $this->getLogger()->info($this->prefix.TextFormat::WHITE.' by zBearchenPlayz enabled!');
    }
    ...
    public function onCommand(CommandSender $sender, Command $command, $label, array $args): bool {
        if($command == 'ol'){
            ...
            if($args['0'] == 'create'){
                ...
                $sender->sendMessage($this->prefix.TextFormat::WHITE.' Bitte setzt den ersten Spawn vom ersten Spieler!');
				return TRUE;
            }
            ...
            if($this->isPlaying($player)){
                ...
                if($mode == 'waiting'){
                    ...
                    $sender->sendMessage($this->prefix.TextFormat::WHITE.' Bitte mach das nicht Ingame');
                    return FALSE;
                }
                return TRUE;
            }else{
            ...
            if($args['0'] == 'show'){
                ...
                if($count > 0){
                    ...
                    $sender->sendMessage($this->prefix.TextFormat::WHITE.' Bitte kauf resetten in unseren Shop');
					return FALSE;
                }
            }
			...
			$sender->transfer('VaronPE.de', 19132);
			return true;
        }
    }
    ...
    public function onInteract(PlayerInteractEvent $event){
        ...
        if($this->mode > 0){
            ...
            if($mode == 1){
                ...
                $this->arenafile->save();
                $this->mode = 2;
                $player->sendMessage($this->prefix.TextFormat::WHITE.' Bitte setzt den Spawn vom zweiten Spieler');
            }elseif($mode == 2){
                if($block->getId() == 0){
                    return;
                }
                ...
                $player->sendMessage($this->prefix.TextFormat::WHITE.' Bitte berühre ein Schild um per Schild zu joinen!');
            }elseif($mode == 3){
                if(!$tile instanceof Sign){
                    return;
                }
            ...
            if($tile instanceof Sign){
                $text = $tile->getText();
                if($text['0'] == $this->prefix){
                    if(TextFormat::clean($text['1']) == 'Beitreten'){
                    ...
                    if($playercount == 0){
                        ...
                        $player->sendMessage($this->prefix.TextFormat::WHITE.' Die Arena ist Voll!');
                        return;
                    }
                }
            }
        ...
        if($this->isPlaying($player)){
            ...
            if($mode == 'waiting'){
                ...
                foreach($players as $p){
                    ...
                    $p->sendMessage($this->prefix.TextFormat::WHITE.' '.$player->getName().' hat das Runde verlassen!');
                }
            }elseif($mode == 'ingame'){
                $arenafile->set('playercount', 0);
                $arenafile->set('mode', 'waiting');
                ...
                foreach($players as $p){
                    ...
                    $p->teleport($this->getServer()->getDefaultLevel()->getSafeSpawn());
                    $p->sendMessage($this->prefix.TextFormat::WHITE.' '.$player->getName().' hat die Runde verlassen!');
                    $p->sendMessage(TextFormat::RED.'Niemand hat gewonnen!');
                }
            }
        }
    }
    ...
    public function onSignChange(SignChangeEvent $event){
        ...
        if($lines['0'] == '[Beitreten]'){
            $event->setLine(0, $this->prefix);
            $event->setLine(1, TextFormat::GREEN.'Beitreten');
            ...
            if($mode == 'waiting'){
                ...
                if($counter == 30){
                    ...
                    foreach($players as $player){
                        ...
                        $player->sendMessage($prefix.TextFormat::WHITE.' Warte auf 2 Spieler');
                    }
                ...
                if($counter == 0){
                    ...
                    foreach($players as $player){
                        ...
                        $player->sendMessage($prefix.TextFormat::WHITE.' Du hast 2 minuten deinen Gegner runtermzuschlagen');
                ...
                if($counter == 60){
                    ...
                    foreach($players as $player){
                        ...
                        $player->sendMessage($prefix.TextFormat::WHITE.' End Zeit: 1 minute');
                        $player->getLevel()->addSound(new ClickSound($player));
                    }
                }
                if($counter == 15){
                    ...
                    foreach($players as $player){
                        ...
                        $player->sendMessage($prefix.TextFormat::WHITE.' End Zeit: 15 sekunden');
                        $player->getLevel()->addSound(new ClickSound($player));
                    }
                }
                if($counter == 5){
                    ...
                    foreach($players as $player){
                        ...
                        $player->sendMessage($prefix.TextFormat::WHITE.' End Zeit: 5 sekunden');
                        $player->getLevel()->addSound(new ClickSound($player));
                    }
                }
                if($counter == 4){
                    ...
                    foreach($players as $player){
                        ...
                        $player->sendMessage($prefix.TextFormat::WHITE.' End Zeit: 4 sekunden');
                        $player->getLevel()->addSound(new ClickSound($player));
                    }
                }
                if($counter == 3){
                    ...
                    foreach($players as $player){
                        ...
                        $player->sendMessage($prefix.TextFormat::WHITE.' End Zeit: 3 sekunden');
                        $player->getLevel()->addSound(new ClickSound($player));
                    }
                }
                if($counter == 2){
                    ...
                    foreach($players as $player){
                        ...
                        $player->sendMessage($prefix.TextFormat::WHITE.' End Zeit: 2 sekunden');
                        $player->getLevel()->addSound(new ClickSound($player));
                    }
                }
                if($counter == 1){
                    ...
                    foreach($players as $player){
                        ...
                        $player->sendMessage($prefix.TextFormat::WHITE.' End Zeit: 1 sekunde');
                        $player->getLevel()->addSound(new ClickSound($player));
                    }
                }
                if($counter == 0){    
                    ...
                    foreach($players as $player){
                        ...
                        if(empty($arenafile->get('winner'))){
                            $player->sendMessage($prefix.TextFormat::WHITE.' Niemand hat gewonnen!');
                        }else{
                            ...
                            if($winner == $playername){
                                ...
                                $player->addTitle(TextFormat::GREEN.'Du hast gewonnen!');
                            }else{
                                ...
                                $kd = $kills / $d;
                                $player->sendMessage($prefix.TextFormat::WHITE.' K/D: '.round($kd, 2));
                                $player->addTitle(TextFormat::RED.' Du hast verloren!');
                            }
                        }
                    }
                    $arenafile->set('mode', 'waiting');
